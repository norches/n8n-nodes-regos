	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Remove for a report prepared',
			},
			{
				name: 'Save',
				value: 'save',
				action: 'Save report prepared',
				description: 'Save for a report prepared',
			},
		],
		default: 'get',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Report0003 for a report request',
			},
			{
				name: 'Report0005',
				value: 'report0005',
				action: 'Report0005 report request',
				description: 'Report0005 for a report request',
			},
			{
				name: 'Report0006',
				value: 'report0006',
				action: 'Report0006 report request',
				description: 'Report0006 for a report request',
			},
			{
				name: 'Report0007',
				value: 'report0007',
				action: 'Report0007 report request',
				description: 'Report0007 for a report request',
			},
			{
				name: 'Report0009',
				value: 'report0009',
				action: 'Report0009 report request',
				description: 'Report0009 for a report request',
			},
			{
				name: 'Report0011',
				value: 'report0011',
				action: 'Report0011 report request',
				description: 'Report0011 for a report request',
			},
			{
				name: 'Report0016',
				value: 'report0016',
				action: 'Report0016 report request',
				description: 'Report0016 for a report request',
			},
			{
				name: 'Report0017',
				value: 'report0017',
				action: 'Report0017 report request',
				description: 'Report0017 for a report request',
			},
			{
				name: 'Report0018',
				value: 'report0018',
				action: 'Report0018 report request',
				description: 'Report0018 for a report request',
			},
			{
				name: 'Report0020',
				value: 'report0020',
				action: 'Report0020 report request',
				description: 'Report0020 for a report request',
			},
			{
				name: 'Report0021',
				value: 'report0021',
				action: 'Report0021 report request',
				description: 'Report0021 for a report request',
			},
			{
				name: 'Report0022',
				value: 'report0022',
				action: 'Report0022 report request',
				description: 'Report0022 for a report request',
			},
			{
				name: 'Report0023',
				value: 'report0023',
				action: 'Report0023 report request',
				description: 'Report0023 for a report request',
			},
			{
				name: 'Report0024',
				value: 'report0024',
				action: 'Report0024 report request',
				description: 'Report0024 for a report request',
			},
			{
				name: 'Report0025',
				value: 'report0025',
				action: 'Report0025 report request',
				description: 'Report0025 for a report request',
			},
			{
				name: 'Report0026',
				value: 'report0026',
				action: 'Report0026 report request',
				description: 'Report0026 for a report request',
			},
		],
		default: 'get',
	},
		...
		options: [
			{
				...
				description: 'Counts for a retail report',
			},
			{
				name: 'Operations',
				value: 'operations',
				action: 'Operations retail report',
				description: 'Operations for a retail report',
			},
			{
				name: 'Payments',
				value: 'payments',
				action: 'Payments retail report',
				description: 'Payments for a retail report',
			},
		],
		default: 'counts',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Remove for an user dashboard',
			},
			{
				name: 'Set',
				value: 'set',
				action: 'Set user dashboard',
				description: 'Set for an user dashboard',
			},
			{
				name: 'Set Default',
				value: 'setDefault',
				action: 'Set default user dashboard',
				description: 'Set default for an user dashboard',
			},
		],
		default: 'get',
	},
		...
		options: [
			{
				...
				description: 'Retrieve a widget data by ID',
			},
		],
		default: 'get',
	},
