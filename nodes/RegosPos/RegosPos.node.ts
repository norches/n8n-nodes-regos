...
export class RegosPos implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Regos POS',
		name: 'regosPos',
		icon: { light: 'file:regos.svg', dark: 'file:regos.dark.svg' },
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
		description: 'REGOS point of sale: cheques, cash sessions, cash operations, fast items',
		defaults: { name: 'Regos POS' },
